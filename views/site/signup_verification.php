                                ...
                                <div class="card-block">
                                    ...
                                    <fieldset>
                                        <div class="col-md-12 col-sm-12 col-xs-12 profile-image-container my-3">
                                        	<?php if ($status == true): ?>
                                        		<i class="fa fa-check-circle icon-big color-primary"></i>     
											<?php else:?>
												<i class="fa fa-warning icon-big color-secondary"></i>
	                                        <?php endif?>
								        </div>
                                        <h3 class="section-title my-3 text-xs-center"><?= $message?></h3>                          
